...
public class Filter implements Filter {
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
        ...
        String edad = request.getParameter("estatura");
        String masaCorporal = request.getParameter("peso");
    
        
        if(estatura != null && edad != null && masaCorporal != null);
            {
                int estatura1 = Integer.parseInt(estatura);
                int edad1 = Integer.parseInt(edad);
                int masaCorporal1 = Integer.parseInt(masaCorporal);
                
                if(estatura1 < 1 && estatura1 > 2.5){
